...
class Model_inner_banner extends MY_Model
{
    ...
    function __construct()
    {
        ...
        $this->pagination_params['fields'] = "inner_banner_id,inner_banner_title,CONCAT(inner_banner_image_path,inner_banner_image) AS inner_banner_image,inner_banner_status";
    ...
    public function get_fields($specific_field = "")
    {
        ...
        $fields = array(
            ...
            'inner_banner_image' => array(
                ...
                'preview' => 'true',
                'attributes'   => array(
                    'image_size_recommended'=>'1600px × 494px',
            ...
            'inner_banner_image2' => array(
                'table' => $this->_table,
                'name' => 'inner_banner_image2',
                'label' => 'Image 2',
                'name_path' => 'inner_banner_image_path',
                'upload_config' => 'site_upload_inner_banner',
                'type' => 'fileupload',
