...
class Manufacture extends MY_Controller {
	...
	public function __construct() {
		...
		parent::__construct();
        $this->dt_params['dt_headings'] = "manufacture_id,manufacture_name,manufacture_status";
        $this->dt_params['searchable'] = array("manufacture_id","manufacture_name","manufacture_status");
        ...
        $this->_list_data['manufacture_status'] = array( 
