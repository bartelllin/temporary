...
class Service_category extends MY_Controller {
	...
	public function __construct() {
		...
		parent::__construct();
        $this->dt_params['dt_headings'] = "service_category_id,service_category_title,service_category_image,service_category_status";
        $this->dt_params['searchable'] = array("service_category_id","service_category_name","service_category_status");
        ...
        $this->_list_data['service_category_status'] = array( 
