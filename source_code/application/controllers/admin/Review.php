...
class Review extends MY_Controller {
	...
	public function __construct() {
		...
		parent::__construct();
        $this->dt_params['dt_headings'] = "review_id,review_name,review_subject,review_status";
        $this->dt_params['searchable'] = array("review_id","review_name","review_status");
        ...
        $this->_list_data['review_status'] = array( 
