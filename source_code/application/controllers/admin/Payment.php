...
class Payment extends MY_Controller {
	...
	public function __construct() {
		...
		parent::__construct();
        $this->dt_params['dt_headings'] = "payment_id,payment_email,payment_link,payment_paid_status,payment_status";
        $this->dt_params['searchable'] = array("payment_id","payment_name","payment_paid_status","payment_status");
        ...
        $this->_list_data['payment_status'] = array( 
