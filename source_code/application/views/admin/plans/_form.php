              ...
              if($form_data){?>
                    ...
                    <div class="tab-pane" id="tab_1">
                      <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                          ...
                          <?
                            //debug($form_data , 1);
                            $price_param['price_relational_id']=$form_data['plans']['plans_id'];
                            $price_param['price_relational_type']=3;
                            $price_param['is_plan']=true;

                          //  $this->load->view("admin/widget/_pricing" , $price_param);
                          ?>
                          <!-- END FORM-->
                        </div>
                      </div>
                    ...
                    <div class="tab-pane" id="tab_2">
                      <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                          <!-- BEGIN FORM-->
                          <? $this->load->view("admin/plans/_attributes");?>
                          <!-- END FORM-->
                        </div>
                      </div>
                    </div>
