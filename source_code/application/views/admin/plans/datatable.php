...
<div class="row">
	<div class="col-md-12">
		...
		<div class="portlet">
			...
			<? $this->load->view('admin/plans/_datatable_filter')?>
				...
				<div class="table-container">
					...
					<tr role="row" class="heading">
						...
						<?foreach ($model_heads as $field) {
							...
							$field_type = $field_attr['type_filter_dt'] ? $field_attr['type_filter_dt'] : $field_attr['type'] ;
							$dt_attributes = $field_attr['dt_attributes'] ;
							
							// Setting up DT Attributes form fields info
							$col_width = $dt_attributes['width'] ;
								...
								switch( $field_type )	
								{
									case 'dropdown':
										...
										$filters .= '<td>'.	
														...
														'</select>'.
													'</td>' ;
										$value = $field_attr['list_data'][$value] ;
										break;
