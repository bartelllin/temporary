...
<center>
<form role="form" method="post" id="forgotPassword" action="">

<div class="col-lg-12">

<div class="form-group">
<label for="email" class="sr-only">Email</label>
<input type="email" name="email" id="email" class="form-control" placeholder="Email" style="width: 50%;">
</div>
...
<center>
<a href="javascript:void(0);" id="submitForgot" class="btn btn-default form-sec">Submit</a>
<hr>
</center>
</form>
</center>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#submitForgot").click(function(){
            ...
            {
                AdminToastr.success("Please check your email for a link to reset your password.",'Success');
                //window.location='<?=g('base_url')?>checkout';
                //window.location='<?=g('base_url')?>';
            }
            else
