...
Class Tkd_form_helper
{
	...
	public function gen_textto($p='')
	{
        $class = (array_filled($p['attributes']>0))?$p['attributes']['class'] : '';
		return '<a href="javascript:void(0)" class="btn btn-sm btn-warning" onclick="copyToClipboard(\'#payment-payment_link\',this)">Copy Reference Link</a>';
	}
	...
	public function gen_date1($p=array())
	{
	...
	public function gen_datetime1($p=array())
	{
	...
	{
		$this->_CI->register_plugins(array("datetimepicker"));
		$p['field_data'] = ($p['field_data']=="0000-00-00" || !$p['field_data'] ) ?  date("Y-m-d H:i") : $p['field_data'] ;
		return '
              <div class="input-group date form_datetime-component">
                    <span class="input-group-btn">
					...
					<input size="16" type="text" value="'.$p['field_data'].'" id="'.$p['id'].'" name="'.$p['field_name'] .'" btn class="form-control datetimepicker '.$p['field']['attributes']['class'].'">
              </div>
		';
	}
	...
	public function gen_date($p=array())
	{
		...
		return '
              <div class="input-group date form_datetime-component">
					...
					<input size="16" type="text" value="'.$p['field_data'].'" id="'.$p['id'].'" name="'.$p['field_name'] .'" btn class="form-control datepicker '.$p['field']['attributes']['class'].'">
              </div>
		';
	}
	...
	public function gen_time($p=array())
	{
		$this->_CI->register_plugins(array("datetimepicker"));
		$p['field_data'] = ($p['field_data']=="0000-00-00" || !$p['field_data'] ) ?  date("Y-m-d H:i") : $p['field_data'] ;
		return '
              <div class="input-group date form_datetime-component">
					...
					<input size="16" type="text" value="'.$p['field_data'].'" id="'.$p['id'].'" name="'.$p['field_name'] .'" btn class="form-control timepicker '.$p['field']['attributes']['class'].'">
              </div>
		';
	}
