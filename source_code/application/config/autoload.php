...
$autoload['libraries'] = array('database','session','cart','account/authentication', 'account/authorization', 'user_agent', 'Recaptcha','pagination');
...
$autoload['helper'] = array('html', 'links', 'form', 'url','file','fileupload','common','tkd_form','inflector','security','text');
